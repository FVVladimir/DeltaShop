...
import { red, green, blueGrey, deepPurple, blue } from '@material-ui/core/colors'
...
const Basket = ({
  ...
  const renderContent = ()=> (
    <Typography component='div' align='center' style={{background: '#e4ebf6'}}>
              ...
              <Card key={index} style={{margin: '.5em'}}>
                <Grid container derection='column'>
                  ...
                  <Grid container derection='row' justify='space-around' alignItems='center' style={{width: '100%'}}>
                    <Typography variant='subtitle1' component='div' style={{ color: blueGrey[600], fontSize: '1.2em'}}>
                      {phone.name}
                    </Typography>
                  ...
                  <Grid container derection='row' justify='space-around' alignItems='center'>
                    ...
                    <Grid container derection='column' justify='space-between' alignItems='center' style={{width: '50%', height: '100%' }} >
                      ...
                      <Grid container direction="row" justify="flex-end" alignItems='center' style={{marginTop: '1em'}}>
                        ...
                        >
                          <Clear style={{ fontSize: '1.2em', color: blueGrey[500]}}/>
                        </IconButton>
                      </Grid>
  ...
  const renderSidebar = ()=> (
    <Grid container direction='column' justify='space-around' alignItems='center' style={{height: '30em', background: '#e4ebf6'}}>
      ...
      {R.not(isBasketEmpty) &&
          <Grid container derection='column' justify='center' alignItems='center' style={{width: '95%', height: '20em', border: `2px solid ${blueGrey[300]}`, borderRadius: '.7em', background: '#ffffff'}}>
            <Button
                    variant='outlined'
                    onClick={cleanBasket}
            ...
            >
              <Grid container derection='row' justify='space-between' alignItems='center' style={{width: '100%'}}>
                ...
                <DeleteForever style={{fontSize: '2em', color: deepPurple[300], marginLeft: '.5em'}}/>
              </Grid>
            </Button>
            ...
            >
              <Grid container derection='row' justify='space-between' alignItems='center' style={{width: '100%'}}>
                ...
                <Drafts style={{fontSize: '2em', color: deepPurple[300], marginLeft: '.5em'}}/>
              </Grid>
            </Button>
  ...
  return (
        <Paper 
            ...
            style={{
              ...
              paddingBottom: '.2em', 
              margin: '1em',
              background: `linear-gradient(135deg, rgba(132,154,184,1) 0%, rgba(241,247,255,1) 100%)`,
            }}
        >
          <Grid 
               container 
          ...
          >
            <Paper 
              elevation={10}
              style={{width: '21em', margin: '3%', paddingTop: '.25em', paddingBottom: '.25em', background: blueGrey[800]}}
            >
