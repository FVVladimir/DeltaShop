...
class Phone extends React.Component{
  ...
  renderContent(){
    ...
    return(
        <Grid 
              ...
              style={{
                      width: '96%', 
                      background: `linear-gradient(90deg, rgba(132,154,184,1) 0%, rgba(241,247,255,1) 100%)`,
                    }}
        >
  ...
  render(){
    ...
    return(
        <Paper 
              elevation={10} 
              style={{width: '93%', paddingTop: '.2em', paddingBottom: '.2em', margin: '1em', boxSizing: 'border-box', background: blueGrey[800]}}
        >
          <Grid 
               container 
               direction="row" 
