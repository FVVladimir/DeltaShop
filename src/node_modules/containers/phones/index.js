...
import { red, green, deepPurple, blueGrey } from '@material-ui/core/colors'
  ...
  renderPhone (phone, index){
    ...
    return (
      <Card key={index} style={{maxWidth: 270, margin: '1em'}}>
          <CardHeader
            avatar={
              <Avatar alt="Delta" style={{backgroundColor: blueGrey[500]}}>
                <SdCardRoundedIcon />
              </Avatar>
            }
            title={phone.name}
          ...
          <CardContent style={{paddingBottom: 14}}>
            ...
            <Typography component="h3">
              <Link to={`/phones/${phone.id}`} style={{textDecoration: 'none', fontWeight: 'bolder', fontSize: '1.2em', color: blueGrey[500]}}>
                {phone.name}
              </Link>
            </Typography>
            ...
            <Typography gutterBottom variant="h5" component="h2">
              <Grid container direction="row" justify="flex-end" style={{fontWeight: 'bolder', color: blueGrey[300]}}>
                ${phone.price}
              </Grid>
            </Typography>
  ...
  render() {
    ...
    return(
      <Layout>
        ...
        <Fab color= "secondary" onClick={loadMorePhones} style={{background: deepPurple['300'], position: 'fixed', bottom: 10, right: 10}}>
          <AddIcon />
        </Fab>
      </Layout>
    )
